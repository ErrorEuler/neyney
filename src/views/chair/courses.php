                            ...
                            <?php else: ?>
                                <?php foreach ($courses as $course): ?>
                                    <tr class="hover:bg-gray-50 transition-all duration-200">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-dark"><?php echo htmlspecialchars($course['units'] ?? '0'); ?></td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-dark">
                                            <?php echo htmlspecialchars($course['lecture_units'] ?? '0'); ?> units<br>
                                            <?php echo htmlspecialchars($course['lecture_hours'] ?? '0'); ?> hours
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-dark">
                                            <?php echo htmlspecialchars($course['lab_units'] ?? '0'); ?> units<br>
                                            <?php echo htmlspecialchars($course['lab_hours'] ?? '0'); ?> hours
                                        </td>
