                                ...
                                <?php foreach ($courses as $course): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?= htmlspecialchars($course['lecture_units'] ?? 0) ?> units<br>
                                            <?= htmlspecialchars($course['lecture_hours'] ?? 0) ?> hours
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?= htmlspecialchars($course['lab_units'] ?? 0) ?> units<br>
                                            <?= htmlspecialchars($course['lab_hours'] ?? 0) ?> hours
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm">
                                            <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full <?= $course['is_active'] ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' ?>">
                                                <?= $course['is_active'] ? 'Active' : 'Discontinue' ?>
                                            </span>
                                        </td>
